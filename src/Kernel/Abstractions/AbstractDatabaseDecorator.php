...
abstract class AbstractDatabaseDecorator
{
    ...
    const TABLE_RECURRENCE_SUB_PRODUCTS_PLAN = 10;
    const TABLE_RECURRENCE_SUB_PRODUCTS_SUBSCRIPTION = 11;
    const TABLE_RECURRENCE_SUB_PRODUCTS_SUBSCRIPTION_REPETITION = 12;
